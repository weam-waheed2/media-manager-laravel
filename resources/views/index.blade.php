                ...
                <div class="col-lg-9 m-auto">
                    <div class="my-3">
                        ...
                        <div class="d-flex">
                            ...
                            <input type="text" hidden value="{{old('image')}}" name="image" id="imageselect" class="filenameselect form-input"
                                readonly="readonly">
            ...
            <div class="row">
                <div class="col-lg-3 m-auto">
                    <div class="mb-2 m-auto">
                        @if(old('image'))
                            <img id="preview-image-before-upload" src="{{old('image')}}"
                                alt="preview image" width="100%">
                        @else
                        <img id="preview-image-before-upload" src="{{asset('no-photo.jpg')}}"
                                alt="preview image" width="100%">
                        @endif
                    </div>
                </div>
