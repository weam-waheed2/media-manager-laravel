            ...
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <ul class="nav nav-media nav-pills nav-tabs my-3" id="pills-tab" role="tablist">
                        ...
                        {{-- <li class="nav-item" role="presentation">
                            <button class="nav-link nav-link-media" id="pills-cropped-tab" data-bs-toggle="pill"
                                data-bs-target="#pills-cropped" type="button" role="tab"
                                aria-controls="pills-cropped" aria-selected="false">Cropped Images</button>
                        </li> --}}
                    </ul>
                </div>
                                    ...
                                    <div class="row">
                                        <div class="col-xl-9 m-auto">
                                            ...
                                            {{--<form action="" method="get" id="form-search">
                                                ...
                                                <div class="input-group my-3">
                                                    <span class="input-group-text"><i class="fa-solid fa-magnifying-glass"></i></span>
                                                    <input type="search" class="form-control" placeholder="Find your image here" name="search" id="search" value="" style="padding: 8px;">
                                                    <button type="submit" class="btn-all btn-add">search</button>
                                                </div>
                                            </form>--}}
                                        </div>
                                        <hr>
